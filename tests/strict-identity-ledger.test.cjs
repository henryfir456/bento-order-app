...
test('frontend wires floor editing, version history, modal preview, and corrected finance permissions', () => {
  ...
  assert.equal(packageJson.version, '0.15.5');
  assert.equal(packageLock.version, '0.15.5');
  assert.equal(packageLock.packages[''].version, '0.15.5');
  ...
  assert.match(changelogMarkdown, /## \[0\.15\.3\] - 2026-09-17/);
  assert.match(changelogMarkdown, /## \[0\.15\.2\] - 2026-09-16/);
  assert.match(changelogMarkdown, /## \[0\.14\.0\] - 2026-09-15/);
